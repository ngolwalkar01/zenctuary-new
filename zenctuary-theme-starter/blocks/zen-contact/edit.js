                ...
                <div className="zen-contact-content-side" style={{ width: `${rightWidth}%` }}>
                    ...
                    <div className="zen-contact-info-rows">
                        <div className="zen-contact-info-row" style={{ marginBottom: '20px', gap: emailSpacing }}>
                            <div className="zen-contact-icon" style={{ 
                                width: emailIconSize, 
                                height: emailIconSize, 
                                color: emailIconUrl ? undefined : emailIconColor 
                            }}>
                                {emailIconUrl ? (
                                    <img src={emailIconUrl} alt="" className="zen-icon" />
                                ) : (
                        ...
                        <div className="zen-contact-info-row" style={{ gap: phoneSpacing }}>
                            <div className="zen-contact-icon" style={{ 
                                ...
                                color: phoneIconUrl ? undefined : phoneIconColor 
                            }}>
                                {phoneIconUrl ? (
                                    <img src={phoneIconUrl} alt="" className="zen-icon" />
                                ) : (

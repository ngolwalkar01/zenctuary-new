...
$css_vars = [
	...
	'--pfc-heading-font-family:' . esc_attr( $attributes['sectionHeadingFontFamily'] ?? 'var(--wp--preset--font-family--montserrat)' ),
	...
	'--pfc-intro-font-family:' . esc_attr( $attributes['sectionIntroFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
	...
	'--pfc-zencoin-label-font-family:' . esc_attr( $attributes['zencoinLabelFontFamily'] ?? 'var(--wp--preset--font-family--montserrat)' ),
	...
	'--pfc-zencoin-badge-font-family:' . esc_attr( $attributes['zencoinBadgeFontFamily'] ?? 'var(--wp--preset--font-family--montserrat)' ),
	...
	'--pfc-title-font-family:' . esc_attr( $attributes['titleFontFamily'] ?? 'var(--wp--preset--font-family--montserrat)' ),
	...
	'--pfc-session-font-family:' . esc_attr( $attributes['sessionFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
	...
	'--pfc-ideal-for-font-family:' . esc_attr( $attributes['idealForFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
	...
	'--pfc-button-font-family:' . esc_attr( $attributes['buttonFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
	...
	'--pfc-expand-label-font-family:' . esc_attr( $attributes['expandLabelFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
	...
	'--pfc-expanded-font-family:' . esc_attr( $attributes['expandedContentFontFamily'] ?? 'var(--wp--preset--font-family--dm-sans)' ),
